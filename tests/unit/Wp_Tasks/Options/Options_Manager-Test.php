...
class Options_Manager_Test extends WP_UnitTestCase
{
    ...
    {
        parent::setUp();
        $this->factory = $this->createMock( Options\Option_Factory::class );
        $this->manager = new Options\Options_Manager( $this->factory );
    }
    ...
    public function testCanResetOptionDefaults() : void
    {
        ...
        $option
            ->expects( $this->once() )
            ->method('add_to_db');
        $this->factory->method('create_option')->willReturn( $option );
